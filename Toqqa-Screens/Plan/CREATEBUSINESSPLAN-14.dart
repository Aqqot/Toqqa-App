...
class XDCREATEBUSINESSPLAN14 extends StatelessWidget {
  XDCREATEBUSINESSPLAN14({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 61.0, 328.0, 53.0),
                    size: Size(328.0, 114.0),
                    child:
                        // Adobe XD layer: 'Question' (text)
                        SingleChildScrollView(
                            child: Text(
                      'Please enter the information of the \nsole proprietor',
                      style: TextStyle(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 11.0, 76.0, 21.0),
                    size: Size(328.0, 48.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 76.0, 21.0),
                          size: Size(76.0, 21.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 11.0, 75.0, 21.0),
                    size: Size(328.0, 48.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 75.0, 21.0),
                          size: Size(75.0, 21.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 11.0, 38.0, 21.0),
                    size: Size(328.0, 48.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
...
const String _svg_dtxguw =
    '<svg viewBox="0.0 0.0 320.0 1.0" ><path  d="M 0 0 L 320 0" fill="none" fill-opacity="0.2" stroke="#707070" stroke-width="10" stroke-opacity="0.2" stroke-miterlimit="4" stroke-linecap="round" /><path  d="M 0 0 L 292.6000061035156 0" fill="none" stroke="#eb6805" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
