...
class XDCREATEBUSINESSPLAN16 extends StatelessWidget {
  XDCREATEBUSINESSPLAN16({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 61.0, 328.0, 62.0),
                    size: Size(328.0, 123.0),
                    child:
                        // Adobe XD layer: 'Question' (text)
                        Text(
                      'Are you satisfied with the information you have provided?',
                      style: TextStyle(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(9.0, 0.0, 101.0, 56.0),
                    size: Size(110.0, 56.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 17.0, 66.0, 14.0),
                    size: Size(110.0, 56.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
...
const String _svg_yj3cl2 =
    '<svg viewBox="0.0 0.0 320.0 1.0" ><path  d="M 0 0 L 320 0" fill="none" fill-opacity="0.2" stroke="#707070" stroke-width="10" stroke-opacity="0.2" stroke-miterlimit="4" stroke-linecap="round" /><path  d="M 0 0 L 319.2000122070313 0" fill="none" stroke="#eb6805" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
