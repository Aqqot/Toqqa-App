...
class XDCREATEBUSINESSPLAN6 extends StatelessWidget {
  XDCREATEBUSINESSPLAN6({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 53.0, 320.0, 51.0),
                    size: Size(328.0, 104.0),
                    child:
                        // Adobe XD layer: 'Question' (text)
                        Text(
                      'Is your business name exactly the \nsame as your personal name?',
                      style: TextStyle(
...
const String _svg_a0ep3v =
    '<svg viewBox="0.0 0.0 320.0 1.0" ><path  d="M 0 0 L 320 0" fill="none" fill-opacity="0.2" stroke="#707070" stroke-width="10" stroke-opacity="0.2" stroke-miterlimit="4" stroke-linecap="round" /><path  d="M 0 0 L 53.20000076293945 0" fill="none" stroke="#eb6805" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
