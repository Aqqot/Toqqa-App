...
class XDCREATEBUSINESSPLAN7 extends StatelessWidget {
  XDCREATEBUSINESSPLAN7({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 53.0, 315.0, 51.0),
                    size: Size(328.0, 104.0),
                    child:
                        // Adobe XD layer: 'Question' (text)
                        Text(
                      'Have you registered this name in \nthe past five years?',
                      style: TextStyle(
                        fontFamily: 'Sofia Pro',
                        fontSize: 20,
...
const String _svg_jvijpz =
    '<svg viewBox="0.0 0.0 320.0 1.0" ><path  d="M 0 0 L 320 0" fill="none" fill-opacity="0.2" stroke="#707070" stroke-width="10" stroke-opacity="0.2" stroke-miterlimit="4" stroke-linecap="round" /><path  d="M 0 0 L 79.80000305175781 0" fill="none" stroke="#eb6805" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
