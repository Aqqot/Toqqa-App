...
class XDREGO5 extends StatelessWidget {
  XDREGO5({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(17.0, 160.0, 324.0, 50.0),
                    size: Size(361.0, 640.0),
                    child:
                        // Adobe XD layer: 'Question' (text)
                        SingleChildScrollView(
                            child: Text(
                      'Please enter your desired PIN below',
                      style: TextStyle(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(257.0, 105.0, 88.0, 16.0),
                    size: Size(361.0, 640.0),
                    child:
                                ...
                                child: Transform.rotate(
                                  ...
                                  child:
                                    ...
                                    children: <Widget>[
                                      ...
                                      Pinned.fromSize(
                                        bounds:
                                            Rect.fromLTWH(8.6, 6.0, 7.4, 12.0),
                                        size: Size(24.0, 24.0),
                                        fixedWidth: true,
                                        fixedHeight: true,
                                        child:
...
const String _svg_mg019j =
    '<svg viewBox="0.0 0.0 320.0 1.0" ><path  d="M 0 0 L 320 0" fill="none" fill-opacity="0.2" stroke="#707070" stroke-width="10" stroke-opacity="0.2" stroke-miterlimit="4" stroke-linecap="round" /><path  d="M 0 0 L 263 0" fill="none" stroke="#eb6805" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
